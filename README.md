...
- The frontend ([app.js](app.js)) reads `devices.json` and shows a device switcher automatically whenever there's more than one device — nothing to change in the UI code when adding more.
